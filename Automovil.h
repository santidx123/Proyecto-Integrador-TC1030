...
class Camioneta : public Automovil {
    ...
    public:
        ...
        Camioneta(int id, string marca, string modelo, string color, string serie, double _precio): Automovil(id, marca, modelo, color, serie, "Camioneta"),
        precio(_precio) {};
