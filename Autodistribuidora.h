...
void Autodistribuidora::autos_registrados() {
    ...
    vehiculos++;
    autos[vehiculos] = new Carro(vehiculos, "Fiat", "Movil", "negro", "delujo", 500000);
    vehiculos++;
    autos[vehiculos] = new Carro(vehiculos, "Fiat", "Movil", "gris", "estandar", 400000);
    vehiculos++;
    autos[vehiculos] = new Carro(vehiculos, "Dodge", "Attitude", "negro", "delujo", 800000);
    vehiculos++;
    autos[vehiculos] = new Carro(vehiculos, "Dodge", "Attitude", "blanco", "delujo", 800000);
    vehiculos++;
    ...
    vehiculos++;
    autos[vehiculos] = new Camioneta(vehiculos, "JEEP", "Wrangler", "negro", "delujo", 1500000);
    vehiculos++;
    autos[vehiculos] = new Camioneta(vehiculos, "JEEP", "Wrangler", "amarillo", "estandar", 1500000);
    vehiculos++;
    ...
    vehiculos++;
    autos[vehiculos] = new Camioneta(vehiculos, "Dodge", "Caravan", "negro", "estandar", 500000);
    vehiculos++;
}
...
void Autodistribuidora::buscar_Automoviles_Usuario(string tipo, string marca, string modelo) {
    for (int i = 0; i < vehiculos; i++) {
      if ((autos[i] -> get_Tipo() == tipo) & (autos[i] -> get_Marca() == marca) & (autos[i] -> get_Modelo() == modelo))
        cout << autos[i] -> imprime_automoviles();
    }
